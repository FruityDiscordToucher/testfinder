...
def make_embed(group_info, date):
    return dict(
        ...
        description=f"**Name**: `{group_info['name']}`\n**MemberCount**: `{group_info['memberCount']}`\n**Clothing**: `{clothingcount(group_info['id'])}`\n**Robux**: `?`",
        thumbnail=dict(url="https://media.discordapp.net/attachments/966077041176875058/986429182462537798/standard_1.gif"),
        color=random.randint(0,16777215),
        footer=dict(
            text="RoTools",
            icon_url="https://media.discordapp.net/attachments/966077041176875058/986429182462537798/standard_1.gif"
        ),
